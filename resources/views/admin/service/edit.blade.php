...
<div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
        <div class="col-md-6"> <h4 class="card-title"> Edit Service</h4></div>
        <div class="col-md-6 "> <h4 class="card-title text-right "> 
        <a href="{{route('service-list')}}" class="btn btn-primary">List of Service</a></h4></div>
              </div>  
              </div>
              <div class="card-body">
              <div class="table-responsive">
                <form action="{{route('service-update',['id'=>$data->id])}}" method="post" enctype='multipart/form-data'>
                @csrf   
