...
@section('seo')
<title>Games for Kids | Fun & Free Kids Games Online | Agamefun</title>
<meta name="description" content="A Game Fun is the #1 site for online fun games for kids of all ages. Play free online exciting games on A Game Fun. These games are built with kids in mind. You can see all our kid's games online and play for free!">
<meta name="keywords" content="games for kids at home, free online games, best free online games for kids, top games online, laptop games online play, Latest games online,1000 free games online, game online for android, free online games on pc no download, online gameplay mobile, a lot of free games">
@endsection
@section('banner')
<h1 class="font-semibold text-white text-4xl">Contact Us</h1>
@endsection
@section('content')
    ...
    <section id="contact" class="ud-contact py-20 md:py-[120px] relative">
      <div
        class=" absolute z-[-1] w-full  h-1/2  lg:h-[45%] xl:h-1/2 bg-[#f3f4fe] top-0 left-0"></div>
            ...
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px]">
                <span
                  ...
                  FUN GAMES TO PLAY FREE NO DOWNLOAD
                </span>
              ...
              <div class="flex flex-wrap justify-between mb-12 lg:mb-0">
                ...
                <div class="flex max-w-full w-[330px] mb-8">
                  ...
                  <div>
                    ...
                    <p class="text-base text-body-color">info@agamefun.com</p>
                    <p class="text-base text-body-color">
                    agamefun106@gmail.com
                    </p>
                  </div>
                </div>
              </div>
